// One-time migration: inserts the site's original content into Supabase.
//
// Run once, locally, after schema.sql:
//   1. cd my-portfolio && npm install
//   2. Add SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY to .env.local
//      (the *service role* key, from Project Settings → API — NOT the anon
//      key, and NEVER put the service key in VITE_-prefixed vars or ship it
//      to the browser: it bypasses every RLS policy in schema.sql).
//   3. npm run seed
//
// Re-running is safe — it upserts by id/title, so editing this file and
...
const projects = [
  {
    id: "saltellite", no: "01", importance: "cover", sort_order: 1,
    kicker: "MAIN FEATURE · AI × REMOTE SENSING", name: "SALTellite",
    ...
    link: "https://github.com/AjwadTahrir/saltellite", year: "2026",
    decisions: [
    ...
    cover_story: {
      ...
      figure: { no: "0.1", caption: "SALTellite — Sentinel-2 salinity monitoring, Selangor coast", src: "/screenshots/saltellite/cover.png", alt: "SALTellite dashboard" },
    },
    visuals: [
      { no: "1.1", caption: "Sentinel-2 salinity risk overlay, Selangor coast", type: "screenshot", src: "/screenshots/saltellite/dashboard.png", alt: "SALTellite dashboard" },
    ],
  },
  {
    id: "fittrack", no: "02", importance: "feature", sort_order: 2,
    kicker: "FEATURE STORY · FULL-STACK WEB", name: "FitTrack",
    ...
    cover_story: null,
    visuals: [
      { no: "2.1", caption: "Nutrition Planner interface, daily view", type: "screenshot", src: "/screenshots/fittrack/nutrition-planner.png", alt: "FitTrack dashboard" },
  ...
  {
    id: "pethealth", no: "03", importance: "note", sort_order: 3,
    kicker: "ENGINEERING NOTES · REQUIREMENTS", name: "Pet Health Records",
  ...
  {
    id: "bizbuddy", no: "04", importance: "feature", sort_order: 4,
    kicker: "FEATURE STORY · AI × FINANCIAL INCLUSION", name: "BizBuddy",
    ...
    link: null, year: "2026", decisions: [], cover_story: null,
    visuals: [
      { no: "4.1", caption: "Cross-border impact, MSMEs onboarded across ASEAN", type: "screenshot", src: "/screenshots/bizbuddy/dashboard.png", alt: "BizBuddy dashboard" },
      { no: "4.2", caption: "Main menu, WhatsApp bot commands", type: "screenshot", src: "/screenshots/bizbuddy/menu.png", alt: "BizBuddy main menu on WhatsApp" },
      { no: "4.3", caption: "AI Penasihat: personalised promotion advice", type: "screenshot", src: "/screenshots/bizbuddy/advisory-chat.png", alt: "BizBuddy AI business advisory chat" },
      { no: "4.4", caption: "A sale logged automatically from a receipt photo", type: "screenshot", src: "/screenshots/bizbuddy/receipt-scan.png", alt: "BizBuddy payment recorded from a photo" },
      { no: "4.5", caption: "Auto-generated sales and profit summary", type: "screenshot", src: "/screenshots/bizbuddy/finance-summary.png", alt: "BizBuddy financial summary" },
      { no: "4.6", caption: "Credit score breakdown for loan eligibility", type: "screenshot", src: "/screenshots/bizbuddy/credit-report.png", alt: "BizBuddy credit score report" },
      { no: "4.7", caption: "Guided path to improve a below-threshold score", type: "screenshot", src: "/screenshots/bizbuddy/credit-gate.png", alt: "BizBuddy credit score gate and SSM verification" },
  ...
  {
    id: "doctelemy", no: "05", importance: "feature", sort_order: 5,
    kicker: "FEATURE STORY · AI × RURAL HEALTHCARE", name: "DocTeleMY",
    ...
    link: null, year: "2026", decisions: [], cover_story: null,
    visuals: [
      { no: "5.1", caption: "App identity", type: "screenshot", src: "/screenshots/doctelemy/logo.png", alt: "DocTeleMY" },
      { no: "5.2", caption: "Onboarding, AI triage support for rural clinics", type: "screenshot", src: "/screenshots/doctelemy/onboarding.png", alt: "DocTeleMY onboarding screen" },
      { no: "5.3", caption: "Clinic dashboard, daily case stats at a glance", type: "screenshot", src: "/screenshots/doctelemy/home-dashboard.png", alt: "DocTeleMY home dashboard for a clinic nurse" },
      { no: "5.4", caption: "Vital signs entry, works fully offline", type: "screenshot", src: "/screenshots/doctelemy/vitals-entry.png", alt: "DocTeleMY vital signs entry form" },
      { no: "5.5", caption: "Structured symptom capture", type: "screenshot", src: "/screenshots/doctelemy/symptoms-entry.png", alt: "DocTeleMY symptom selection screen" },
      { no: "5.6", caption: "Gemini triage verdict: mild case", type: "screenshot", src: "/screenshots/doctelemy/assessment-mild.png", alt: "DocTeleMY mild assessment result" },
      { no: "5.7", caption: "Gemini triage verdict: severe case flagged for emergency care", type: "screenshot", src: "/screenshots/doctelemy/assessment-severe.png", alt: "DocTeleMY severe emergency assessment result" },
  ...
  {
    id: "foodies", no: "07", importance: "note", sort_order: 6,
    kicker: "ENGINEERING NOTES · MOBILE", name: "Foodies",
    ...
    visuals: [
      ...
      { no: "7.2", caption: "Sign in to start saving food", type: "screenshot", src: "/screenshots/foodies/signin.png", alt: "Foodies sign in screen" },
      { no: "7.3", caption: "Home, featured foods nearby", type: "screenshot", src: "/screenshots/foodies/home-dashboard.png", alt: "Foodies home dashboard" },
      { no: "7.4", caption: "My Foods, sell or give an item away", type: "screenshot", src: "/screenshots/foodies/my-foods.png", alt: "Foodies My Foods add-item sheet" },
      { no: "7.5", caption: "Listing a food item for sale", type: "screenshot", src: "/screenshots/foodies/list-item.png", alt: "Foodies list an item for sale form" },
      { no: "7.6", caption: "Search, live food listings", type: "screenshot", src: "/screenshots/foodies/search.png", alt: "Foodies search results" },
      { no: "7.7", caption: "Profile, impact stats and account", type: "screenshot", src: "/screenshots/foodies/profile.png", alt: "Foodies profile screen" },
    ],
  },
  {
    id: "alzheimers-iot", no: "08", importance: "note", sort_order: 7,
    kicker: "ENGINEERING NOTES · ARCHITECTURE", name: "Alzheimer's Care IoT System",
    ...
    link: null, year: "2026", decisions: [], cover_story: null, visuals: [],
  },
  {
    id: "marz-tamam-db", no: "09", importance: "note", sort_order: 8,
    kicker: "ENGINEERING NOTES · DATA", name: "MARZ TAMAM Inventory System",
    ...
    link: null, year: "2025", decisions: [], cover_story: null, visuals: [],
  },
];

const archiveItems = [
  { id: "travel", kicker: "TRAVEL", title: "Field Notes", dek: "Places I've been, roads I've taken, and wherever's next.", placeholder: null, sort_order: 1 },
  { id: "university", kicker: "UNIVERSITY", title: "Campus Life", dek: "Universiti Malaya, Software Engineering — the parts that don't fit in a project card.", placeholder: "TODO — campus content", sort_order: 2 },
  { id: "running", kicker: "RUNNING", title: "The Log", dek: "21,000+ metres of questionable decisions across two half marathons.", placeholder: null, sort_order: 3 },
  { id: "photography", kicker: "PHOTOGRAPHY", title: "Shots", dek: "TODO — a line about what you shoot.", placeholder: "TODO — photo grid", sort_order: 4 },
  { id: "life", kicker: "LIFE", title: "Off The Record", dek: "TODO — whatever else belongs here.", placeholder: "TODO — life content", sort_order: 5 },
];

const reports = [
  { title: "SHORTCUT ASIA CHALLENGE 2026", outcomes: ["Screening round passed", "In-person presentation round completed"], sort_order: 1 },
  { title: "BORNEOHACK 2026", outcomes: ["Top 20 Finalist — BizBuddy", "Recognised for ASEAN financial inclusion"], sort_order: 2 },
  { title: "KITAHACK & UMHACKATHON", outcomes: ["AI healthcare solution built — DocTeleMY", "Quantitative training model proposed"], sort_order: 3 },
  { title: "SOFTWARE ENGINEERING PROJECT", outcomes: ["Managed 10-person team", "Delivered full requirements package"], sort_order: 4 },
  { title: "RESEARCH PROJECT", outcomes: ["105 survey respondents", "Cronbach α = .955, full statistical analysis"], sort_order: 5 },
  { title: "LEADERSHIP & INTERNATIONAL", outcomes: ["Secretary, XTalent · Head of Logistics, Bengkel Protocol", "Exchange programmes — Thailand & Indonesia"], sort_order: 6 },
];

const stats = [
  { value: "50+", label: "Functional requirements written", sort_order: 1 },
  { value: "105", label: "Survey responses analysed", sort_order: 2 },
  { value: "10", label: "Developers coordinated", sort_order: 3 },
  { value: "786 km", label: "Satellite orbit height", sort_order: 4 },
  { value: "3+", label: "AI systems built", sort_order: 5 },
];

async function run() {
  const steps = [
    ["projects", projects, "id"],
    ["archive_items", archiveItems, "id"],
    ["reports", reports, "title"],
    ["stats", stats, "value,label"],
  ];
  for (const [table, rows, conflictTarget] of steps) {
